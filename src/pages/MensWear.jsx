...
const MensWear = ({user, handleAuthPopup}) => {
  ...
  if (loading) return <div className="p-20 text-center text-gray-500 text-xl">Loading Mens Wear...</div>;
