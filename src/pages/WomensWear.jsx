...
const WomensWear = ({user, handleAuthPopup}) => {
  ...
  const fetchWomensWear = async () => {
    setLoading(true);
    // Join products with categories and filter by category name
    const { data, error } = await supabase
      ...
      `)
      .eq('categories.name', 'Womens Wear'); // Filter specifically for this category
      console.log(data);
  ...
  if (loading) return <div className="p-20 text-center text-gray-500 text-xl">Loading Womens Wear...</div>;
